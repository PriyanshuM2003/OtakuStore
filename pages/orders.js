                ...
                {Object.values(order.products).map((product) => (
                  ...
                  >
                    <td className="py-4 px-6 font-semibold text-gray-900 dark:text-white">
                      <h1 className="text-lg text-purple-800 cursor-pointer">
                        #{order.order_id}
                      </h1>
                      <p className="flex text-xs title-font tracking-widest">
                        Order placed on:
                      ...
                      <Link href={`/order?id=${order._id}`} legacyBehavior>
                        <button className="text-white mt-2 font-semibold bg-purple-900 border-0 py-1 px-2 focus:outline-none hover:text-yellow-400 rounded">
                          Track Order
                        </button>
                      </Link>
                    </td>
                    ...
                    <td className="py-4 px-6 font-semibold text-gray-900 dark:text-white">
                      <h1 className="text-purple-800 text-lg">
                        {product.name}
                      </h1>
