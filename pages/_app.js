...
function MyApp({ Component, pageProps }) {
  ...
  const removeFromCart = (itemCode, qty, price, name, size, variant, img, category) => {
  ...
  return <>
    ...
    />
    {key && <Navbar user={user} admin={admin} logout={logout} adminLogout={adminLogout} key={key} cart={cart} addToCart={addToCart} removeFromCart={removeFromCart} clearCart={clearCart} subTotal={subTotal} />}
