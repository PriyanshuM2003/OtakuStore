...
const Posters = ({ products }) => {
    ...
    return <>
        <Head>
            <title>Otaku Store- Posters</title>
        ...
        <section className='min-h-screen text-gray-700 body-font'>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="md:flex md:items-baseline justify-between inline-block border-b border-gray-200 pb-4 pt-20">
                    <h1 className="text-4xl font-bold tracking-tight text-purple-900">Posters</h1>
...
export async function getServerSideProps(context) {
    ...
    let products = await Product.find({ category: 'Poster' })
