                        ...
                        <div className="min-h-full w-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                            <div className="min-w-md w-full space-y-8">
                                <div>
                                    ...
                                    <h2 className="mt-6 text-center text-3xl font-extrabold text-purple-800">Admin Sign up</h2>
                                    <p className="mt-2 text-center text-sm text-gray-600">
                                        Or <br />
                                        <Link href={'/admin/adminlogin'}>
                                            <a className="font-medium text-purple-900 hover:text-purple-700">Admin Login</a>
                                        </Link>
                                    </p>
                                </div>
                                <form onSubmit={handleSubmit} className="w-full" method="POST">
                                    <div className="flex flex-wrap -mx-3 ">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <label className="block appearance-none uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="Skey">
                                                Secret Key
                                            </label>
                                            <input onChange={handleChange} value={Skey} name="Skey" required className="w-1/2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="Skey" type="text" />
                                        </div>
                                    </div>
                                    <div className="flex flex-wrap -mx-3 ">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
