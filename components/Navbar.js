      ...
      <div className={styles.navbar}>
        <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row">
          ...
          <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center justify-center text-base font-semibold">
            <Link href={'/tshirts'} className="mr-5 md:mr-10 hover:text-yellow-400">
              T-Shirts
            </Link>
            <Link href={'/actionfigs'} className="mr-5 md:mr-10 hover:text-yellow-400">
              ActionFigs.
            </Link>
            <Link href={'/costumes'} className="mr-5 md:mr-10 hover:text-yellow-400">
              Costumes
            </Link>
            <Link href={'/replicas'} className="mr-5 md:mr-10 hover:text-yellow-400">
              Replicas
            </Link>
            <Link href={'/pillows'} className="mr-5 md:mr-10 hover:text-yellow-400">
              Pillows
            </Link>
            <Link href={'/bedsheets'} className="mr-5 md:mr-10 hover:text-yellow-400">
              Bedsheets
            </Link>
            <Link href={'/stickers'} className="mr-5 md:mr-10 hover:text-yellow-400">
              Stickers
            </Link>
            <Link href={'/posters'} className="mr-5 md:mr-20 hover:text-yellow-400">
              Posters
            </Link>
          </nav>
          ...
          {admin.value && !user.value && <Link href={'/admin'} legacyBehavior>
          ...
          <div ref={ref} className={`sideCart z-20 overflow-y-auto no-scrollbar absolute top-0 right-0 p-12 w-84 h-screen bg-purple-900 transform transition-transform ${sidebar ? 'translate-x-0' : 'translate-x-full'} `}>
            ...
            <div className='flex mx-auto mt-16 items-center justify-center'>
              {Object.keys(cart).length > 0 && (
                <Link href={'/mycart'} legacyBehavior><button className="flex mx-2 w-auto items-center justify-center text-purple-900 font-bold bg-gray-100 border-0 py-2 px-4 focus:outline-none disabled:bg-slate-400 hover:bg-yellow-400 rounded"><BsFillBagCheckFill className='text-2xl mr-1' />My Cart</button></Link>
              )}
              {Object.keys(cart).length > 0 && (
